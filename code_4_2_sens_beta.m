%% ========================================================================
%  File:    code_4_2_sens_beta.m
%  Author:  Yaoyao Zheng
%  Email:   zhengyaoyao@stu.pku.edu.cn
%  MATLAB:  R2026a
%
%  Description:
%  Computes pixel-wise sensitivity of phenological transition dates to 
%  pre-season climate variables.
% =========================================================================
...
products     = ["gimms_lai4g", "gimms_lai3g", "mcd12q2", "yuan_lai"];
...
for idx = 1:size(prod_list, 1)
    ...
    year_start = prod_list{idx, 2};
    year_end   = prod_list{idx, 3};

    fprintf('\n[Info] ====== Processing %s (%d-%d) ======\n', prod, year_start, year_end);
    start_time = tic;
