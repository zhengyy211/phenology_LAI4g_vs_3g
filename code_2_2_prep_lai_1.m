...
doy_list   = cfg.lai.glass_modis.doy_list;
...
for lai_prod = ["gimms_lai4g", "gimms_lai3g"]
    ...
    parfor idx_comb = 1:height(combs_time)
        ...
        elseif lai_prod == "gimms_lai4g"
            [lai, qc_2] = read_gimms_lai4g(fullfile(dir_raw, lai_prod), current_year, current_month, current_half);
            qc = mod(qc_2, 10);
        end
...
glass_spatial_res = 0.05;  % GLASS dataset has 0.5° resolution
...
%% ------ STEP 3.1: Read LAI data for each year ------
